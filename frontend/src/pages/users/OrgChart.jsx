...
function computeLayout(users) {
    ...
    // Build edges from node positions
    const nodeMap = {};
    ...
    const maxX = nodes.reduce((m, n) => Math.max(m, n.x + NODE_W), 800);
    const maxY = nodes.reduce((m, n) => Math.max(m, n.y + NODE_H), 400);
            ...
            {loading ? (
                ...
                <>
                    <div style={{ fontSize: '0.8rem', color: 'var(--text-muted)', marginBottom: '0.75rem' }}>
                        Click any node to edit the user and set their reporting line.
                    </div>
                    <div
                        className="glass-card org-chart-container"
