...
export const ticketsApi = {
    ...
    hold: (id, data) => api.post(`/tickets/${id}/hold`, data),
    ...
    requestSlaExtension: (id, reason) => api.post(`/tickets/${id}/request-sla-extension`, { reason }),
    approveSlaExtension: (id, newSlaRestoreDue) => api.post(`/tickets/${id}/sla-extension/approve`, { newSlaRestoreDue }),
    rejectSlaExtension: (id, rejectionReason) => api.post(`/tickets/${id}/sla-extension/reject`, { rejectionReason }),
