...
export const getProjects = asyncHandler(async (req, res, next) => {
  ...
  if (search) {
    ...
    query.$or = [
      { projectName: new RegExp(safeSearch, 'i') },
      { clientName: new RegExp(safeSearch, 'i') },
      { projectNumber: new RegExp(safeSearch, 'i') }
    ];
  }
 ...
 * @access  Private
 */
export const getProjectDashboard = asyncHandler(async (req, res, next) => {
 ...
 * @access  Private
 */
export const getProjectZones = asyncHandler(async (req, res, next) => {
 ...
 * @access  Private (Admin, Supervisor)
 */
export const updateProjectZone = asyncHandler(async (req, res, next) => {
 ...
 * @access  Private (Admin, Supervisor)
 */
export const deleteProjectZone = asyncHandler(async (req, res, next) => {
  const zone = await ProjectZone.findByIdAndUpdate(
    req.params.id,
    { isActive: false },
    { new: true }
 ...
 * @access  Private
 */
export const getPMDailyLogs = asyncHandler(async (req, res, next) => {
 ...
 * @access  Private
 */
export const getPMDailyLogById = asyncHandler(async (req, res, next) => {
 ...
 * @access  Private
 */
export const updatePMDailyLog = asyncHandler(async (req, res, next) => {
  const log = await PMDailyLog.findById(req.params.id);
 ...
 * @access  Private (Admin)
 */
export const lockPMDailyLog = asyncHandler(async (req, res, next) => {
  const log = await PMDailyLog.findById(req.params.id);
 ...
 * @access  Private (Admin)
 */
export const unlockPMDailyLog = asyncHandler(async (req, res, next) => {
  const log = await PMDailyLog.findById(req.params.id);
 ...
 * @access  Private
 */
export const uploadPMLogPhotos = asyncHandler(async (req, res, next) => {
  const log = await PMDailyLog.findById(req.params.id);
 ...
 * @access  Private
 */
export const getDeviceInstallations = asyncHandler(async (req, res, next) => {
 ...
 * @access  Private
 */
export const getDeviceInstallationById = asyncHandler(async (req, res, next) => {
 ...
 * @access  Private
 */
export const createDeviceInstallation = asyncHandler(async (req, res, next) => {
 ...
 * @access  Private
 */
export const createBulkDeviceInstallations = asyncHandler(async (req, res, next) => {
 ...
 * @access  Private
 */
export const updateDeviceInstallation = asyncHandler(async (req, res, next) => {
 ...
 * @access  Private
 */
export const updateDeviceStatus = asyncHandler(async (req, res, next) => {
    ...
    if (!device.convertedToAsset) {
      try {
        ...
        if (!siteId) {
          ...
          const addressPrefix = device.projectId?.siteAddress?.split(',')[0];
          const projectSite = addressPrefix ? await Site.findOne({
            siteName: { $regex: new RegExp(escapeRegex(addressPrefix), 'i') },
            isActive: true
          }) : null;
 ...
 * @access  Private
 */
export const getDeviceSummary = asyncHandler(async (req, res, next) => {
 ...
 * @access  Private
 */
export const getVendorWorkLogs = asyncHandler(async (req, res, next) => {
 ...
 * @access  Private
 */
export const getVendorWorkLogById = asyncHandler(async (req, res, next) => {
 ...
 * @access  Private
 */
export const createVendorWorkLog = asyncHandler(async (req, res, next) => {
 ...
 * @access  Private
 */
export const updateVendorWorkLog = asyncHandler(async (req, res, next) => {
 ...
 * @access  Private
 */
export const getMyVendorLogs = asyncHandler(async (req, res, next) => {
 ...
 * @access  Private
 */
export const getChallengeLogs = asyncHandler(async (req, res, next) => {
 ...
 * @access  Private
 */
export const getChallengeLogById = asyncHandler(async (req, res, next) => {
 ...
 * @access  Private
 */
export const createChallengeLog = asyncHandler(async (req, res, next) => {
  const challengeData = {
    ...req.body,
 ...
 * @access  Private
 */
export const updateChallengeLog = asyncHandler(async (req, res, next) => {
 ...
 * @access  Private
 */
export const resolveChallengeLog = asyncHandler(async (req, res, next) => {
  const challenge = await ChallengeLog.findByIdAndUpdate(
    req.params.id,
    {
 ...
 * @access  Private (Admin, Supervisor)
 */
export const getEscalatedChallenges = asyncHandler(async (req, res, next) => {
 ...
 * @access  Private
 */
export const addChallengeComment = asyncHandler(async (req, res, next) => {
  const challenge = await ChallengeLog.findById(req.params.id);
 ...
 * @access  Private (Admin, Supervisor)
 */
export const getProjectReport = asyncHandler(async (req, res, next) => {
 ...
 * @access  Private (Admin, Supervisor)
 */
export const exportProjectReportPDF = asyncHandler(async (req, res, next) => {
 ...
 * @access  Private (Admin, Supervisor)
 */
export const exportProjectReportExcel = asyncHandler(async (req, res, next) => {
 ...
 */
export const getDevicesAwaitingAssignment = asyncHandler(async (req, res, next) => {
 ...
 * @access  Private
 */
export const getMyDeviceAssignments = asyncHandler(async (req, res, next) => {
 ...
 * @access  Private (Admin, Supervisor, PM)
 */
export const assignDeviceToEngineer = asyncHandler(async (req, res, next) => {
 ...
 * @access  Private (Admin, Supervisor, PM)
 */
export const bulkAssignDevices = asyncHandler(async (req, res, next) => {
 ...
 * @access  Private (Admin, Supervisor, PM)
 */
export const skipDeviceConfiguration = asyncHandler(async (req, res, next) => {
 ...
 * @access  Private (Admin, Supervisor, PM)
 */
export const unassignDevice = asyncHandler(async (req, res, next) => {
  const deviceId = req.params.id;
 ...
 * @access  Private
 */
export const getReconciliation = asyncHandler(async (req, res, next) => {
  const { projectId } = req.params;
 ...
 * @access  Private
 */
export const getReconciliationDevices = asyncHandler(async (req, res, next) => {
  const { projectId } = req.params;
 ...
 * @access  Private (Admin/Supervisor)
 */
export const resyncSurveyRequirements = asyncHandler(async (req, res, next) => {
  const { projectId } = req.params;
 ...
 * @access  Private
 */
export const getDeviceMappings = asyncHandler(async (req, res, next) => {
 ...
 * @access  Private (Admin/Supervisor)
 */
export const deleteDeviceMapping = asyncHandler(async (req, res, next) => {
  const { id } = req.params;
 ...
 * @access  Private (Admin/Supervisor)
 */
export const getUnmappedSurveyItems = asyncHandler(async (req, res, next) => {
