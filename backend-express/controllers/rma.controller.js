...
// @route   GET /api/rma
// @access  Private
export const getAllRMAs = asyncHandler(async (req, res, next) => {
...
// @route   POST /api/rma
// @access  Private
export const createRMA = asyncHandler(async (req, res, next) => {
  const {
    ticketId,
    requestReason,
    shippingDetails,
...
// @access  Private
export const getRMAByTicket = asyncHandler(async (req, res, next) => {
...
export const getTransferSpares = asyncHandler(async (req, res, next) => {
...
// @access  Private
export const getRMAHistory = asyncHandler(async (req, res, next) => {
...
export const updateRMAStatus = asyncHandler(async (req, res, next) => {
  let {
    status,
    remarks,
    vendorDetails,
